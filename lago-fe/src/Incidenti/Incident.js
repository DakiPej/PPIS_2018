...
class Incident extends Component {
    ...
    toggleNovaPoruka = () => {
        this.setState(
            {openNovaPoruka:!this.openNovaPoruka}
        );
    }
        ...
        switch (role) {
            case 'Administrator':
                if (this.state.data.departmentName === '')
                    table = <div style={{ padding: "1%", overflowY: "scroll", maxHeight: "60vh" }}>
                        ...
                        <Panel id="collapsible-panel-example-2" defaultClosed expanded={this.state.openOpis} onClick={this.toggleOpis}>
                            <Panel.Heading>
                    ...
                    table = <div style={{ padding: "1%", overflowY: "scroll", maxHeight: "60vh" }}>
                        ...
                        <Panel bsStyle="info" id="collapsible-panel-example-2" defaultClosed>  defaultClosed onClick={this.togglePoruke} isOpen={this.state.openPoruke}
                            <Panel.Heading>
                            ...
                            <Panel.Collapse>
                                ...
                                <div style={{ padding: "2.5%" }}>
                                    <Panel id="collapsible-panel-example-2" defaultClosed expanded={this.state.openNovaPoruka} onClick={this.toggleNovaPoruka}>
                                        <Panel.Heading>
            ...
            case 'Korisnik':
                table = <div style={{ padding: "1%", overflowY: "scroll", maxHeight: "60vh" }}>
                    ...
                    <Panel bsStyle="info" id="collapsible-panel-example-2" defaultClosed expanded={this.state.openPoruke} onClick={this.togglePoruke}>
                        <Panel.Heading>
                            <Panel.Title toggle componentClass="h3" >Poruke</Panel.Title>
                        </Panel.Heading>
                        <Panel.Collapse>
            ...
            case 'Odjel':
                if (this.props.tip === 'Nedodijeljen') {
                    table = <div style={{ padding: "1%", overflowY: "scroll", maxHeight: "60vh" }}>
                        ...
                        <Panel id="collapsible-panel-example-2" defaultExpanded expanded={this.state.openOpis} onClick={this.toggleOpis}>
                            <Panel.Heading>
                                <Panel.Title toggle componentClass="h5">
                                    Opis
                  </Panel.Title>
